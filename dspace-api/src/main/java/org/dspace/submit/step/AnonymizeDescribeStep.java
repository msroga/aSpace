 ...
 * @version $Revision$
 */
public class AnonymizeDescribeStep extends AbstractProcessingStep
{
    /** log4j logger */
    private static Logger log = Logger.getLogger(AnonymizeDescribeStep.class);
    ...
    /** Constructor */
    public AnonymizeDescribeStep() throws ServletException
    {
