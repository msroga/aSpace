...
public class SubmissionConfigReader
{
   ...
   public static final String ANONYMIZE_COLLECTION = "anonymize";
    ...
    * @param isWorkflow       whether or not we are loading the submission process for a
    *                         workflow
    * @return the SubmissionConfig representing the item submission config
    * @throws ServletException if no default submission process configuration defined
    */
   public SubmissionConfig getSubmissionConfig(String collectionHandle,
                                               boolean isWorkflow, boolean anonymize) throws ServletException
   {
      ...
      if (submitName == null && anonymize)
      {
         submitName = collectionToSubmissionConfig
                 .get(ANONYMIZE_COLLECTION);
      }
      if (submitName == null)
      {
         submitName = collectionToSubmissionConfig
