...
<table class="table" align="center" summary="Table dispalying your submitted files">
    ...
    <tr>
        ...
        <td headers="t5" class="<%= row %>RowEvenCol">
            ...
            <button type="submit" class="btn btn-default pull-right" name="submit_anonymize_<%= bitstreams[i].getID() %>" value="<fmt:message key="jsp.submit.upload-file-list.button1"/>">
                <span class="glyphicon glyphicon-file"></span>&nbsp;&nbsp;<fmt:message key="org.dspace.app.webui.jsptag.ItemTag.anonymize"/>
            </button>
            <button type="submit" class="btn btn-default pull-right" name="submit_revert_<%= bitstreams[i].getID() %>" value="<fmt:message key="jsp.submit.upload-file-list.button1"/>">
                <span class="glyphicon glyphicon-file"></span>&nbsp;&nbsp;<fmt:message key="org.dspace.app.webui.jsptag.ItemTag.revert"/>
            </button>
        </td>
        <%
            // Checksum
