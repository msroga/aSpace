 ...
 * @version $Revision$
 */
public class JSPAnonymizeDescribeStep extends JSPStep
{
    /** JSP which displays HTML for this Class * */
    private static final String DISPLAY_JSP = "/submit/anonymize-metadata.jsp";

    /** JSP which reviews information gathered by DISPLAY_JSP * */
    private static final String REVIEW_JSP = "/submit/review-metadata.jsp";

    /** log4j logger */
    private static Logger log = Logger.getLogger(JSPAnonymizeDescribeStep.class);

    /** Constructor */
    public JSPAnonymizeDescribeStep() throws ServletException
    {
